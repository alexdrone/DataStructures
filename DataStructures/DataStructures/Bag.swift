...
//  DataStructures
//
//  Created by Alex Usbergo on 08/01/16.
//  Copyright © 2016 Alex Usbergo. All rights reserved.
//

import Foundation

/// A Bag is a special kind of set in which
/// members are allowed to appear more than once. It's possible to convert a bag
/// to a set: `let set = Set(bag)`
public struct Bag<T: Hashable> {
    ...
    /// Constructs a bag from a sequence, such as an array.
    ...
    /// Number of elements stored in the bag, including multiple copies.
    ...
    /// Number of distinct elements stored in the bag.
    ...
    /// Inserts a single occurrence of an element into the bag.
    ///
    ...
    /// Inserts a number of occurrences of an element into the bag.
    ///
    /// - returns: The number of occurrences of the element before the operation.
    ...
    /// Removes a single occurrence of an element from the bag, if present.
    ///
    /// - returns: The number of occurrences of the element before the operation.
    ...
    /// Removes a number of occurrences of an element from the bag.
    /// If the bag contains fewer than this number of occurrences to begin with,
    ...
    /// Removes all occurrences of an element from the bag, if present.
    ///
    /// - returns: The number of occurrences of the element before the operation.
    ...
    /// Removes all the elements from the bag, and by default
...
extension Bag: ArrayLiteralConvertible {
    ...
    /// Constructs a bag using an array literal.
...
// MARK: Bag Equatable Conformance
